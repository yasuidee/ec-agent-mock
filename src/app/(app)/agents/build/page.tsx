    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <Tabs defaultValue="proposals">
        <TabsList className="bg-white border border-slate-200 rounded-xl p-1 flex gap-1 h-auto w-full">
          ...
          <TabsTrigger value="generator" className="flex items-center gap-2 px-4 py-4 rounded-lg text-sm font-medium text-slate-500 transition-all duration-150 data-[state=active]:bg-blue-900 data-[state=active]:text-white data-[state=active]:shadow-sm hover:text-slate-700 hover:bg-slate-50 data-[state=active]:hover:bg-blue-900 data-[state=active]:hover:text-white flex-1 justify-center">
